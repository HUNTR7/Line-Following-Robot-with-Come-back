...
ISR( INT6_vect ) {
  ...
  if ( state_e0 == 0 || state_e0 == 3 || state_e0 == 5 || state_e0 == 6 || state_e0 == 9 || state_e0 == 10 || state_e0 == 12 || state_e0 == 15) {
    count_e0 = count_e0;
...
ISR( PCINT0_vect ) {
  ...
  // Complete this if statement as necessary.
  // Refer to the labsheet.
  if ( state_e1 == 0 || state_e1 == 3 || state_e1 == 5 || state_e1 == 6 || state_e1 == 9 || state_e1 == 10 || state_e1 == 12 || state_e1 == 15) {
    count_e1 = count_e1;
